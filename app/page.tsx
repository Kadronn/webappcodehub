...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-slate-800 font-sans selection:bg-blue-600 selection:text-white bg-[#f0f7ff] relative overflow-x-hidden">
      
      {/* 🔮 ŞEKİLLİ ŞÜKÜLLÜ ARKA PLAN ELEMENTLERİ */}
      {/* 1. Geometrik Izgara Çizgileri (Grid Desen) */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#e0f2fe_1px,transparent_1px),linear-gradient(to_bottom,#e0f2fe_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none z-0"></div>
      
      {/* 2. Köşelerden Parlayan Soyut Neon Işık Küreleri */}
      <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-blue-300/30 rounded-full blur-[120px] pointer-events-none z-0"></div>
      <div className="absolute top-[20%] right-[-10%] w-[600px] h-[600px] bg-indigo-200/40 rounded-full blur-[130px] pointer-events-none z-0"></div>
      <div className="absolute bottom-[10%] left-[-20%] w-[500px] h-[500px] bg-cyan-200/30 rounded-full blur-[120px] pointer-events-none z-0"></div>

      {/* 🌐 SEO BAŞLIK YAPISI (Google Arama Motoru İçin Görünmez Meta Tag Yardımı) */}
      <title>Web Sitesi Açma, Yapma & Web Tasarımı | Mobil Uygulama Yapma & Satılık Mobil Uygulama (MiraMi) | Bot Yazdırma</title>

      {/* Üst Menü / Navbar */}
      <header className="border-b border-blue-200/80 bg-white/80 backdrop-blur-md sticky top-0 z-50 shadow-sm">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <span className="text-xl">✨</span>
            <h1 className="text-lg font-black tracking-wider text-slate-950">
              MIRAMI | <span className="text-blue-600">WEB & MOBİL UYGULAMA YAPMA OFİSİ</span>
            </h1>
          </div>
          <a href="#order-form" className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white px-5 py-2 rounded-xl font-bold text-xs uppercase tracking-wider transition-all shadow-md shadow-blue-600/10 transform hover:-translate-y-0.5">
            Hemen Talep Gönder
          </a>
        </div>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-6 py-16 relative z-10">
        ...
        <section className="text-center mb-16">
          <span className="text-[11px] font-bold uppercase tracking-widest text-blue-700 border border-blue-300 px-4 py-1.5 rounded-full bg-blue-100 shadow-sm inline-block">
            ⚡ Web Sitesi Açma, Web Tasarımı ve Akıllı Bot Sistemleri
          </span>
          ...
          <p className="text-slate-600 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            İster esnaf dükkanın için hızlı bir web sitesi açma hizmeti, ister profesyonel web tasarımı veya süreçleri otomatikleştiren bot yazdırma çözümleri... En modern teknolojilerle hizmetinizdeyiz.
          </p>
        </section>

        {/* 🌟 ÖZEL VİTRİN: SATILIK MOBİL UYGULAMA (MIRAMI) */}
        <section className="mb-20 bg-white/95 border-2 border-pink-400/80 rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden backdrop-blur-sm">
          ...
          {/* MiraMi Görsel Alanı */}
          <div className="mb-6 rounded-2xl overflow-hidden border border-pink-100 bg-white shadow-md">
            <img 
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-4 border-t border-slate-100">
            ...
            <a href="#order-form" onClick={() => setFormData({...formData, service: 'mirami', details: 'MiraMi Hazır Satılık Mobil Uygulama projesini incelemek ve satın almak istiyorum.'})} className="bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-500 hover:to-rose-500 text-white text-xs font-bold uppercase tracking-wider px-6 py-3.5 rounded-xl transition-all shadow-md shadow-pink-600/10 inline-flex items-center gap-1 cursor-pointer w-full sm:w-auto justify-center transform hover:-translate-y-0.5">
        ...
        <section className="mb-20">
          ...
          <p className="text-slate-500 text-xs text-center mb-10">İhtiyacın olan dijital çözümü seç, Google'da rakiplerinin önüne geç kanka.</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            
            {/* 1. Web Sitesi Açma ve Yapma */}
            <div className="bg-white/95 rounded-2xl border border-blue-100 shadow-md overflow-hidden flex flex-col justify-between hover:shadow-lg transition-all">
              <div>
                <div className="h-48 relative overflow-hidden bg-slate-900">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent flex flex-col justify-end p-4">
                    ...
                    <div className="font-bold text-white text-sm">Profesyonel Web Sitesi Açma</div>
                  </div>
                </div>
                <div className="p-6">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-base font-bold text-slate-900">Web Sitesi Yapma (Esnaf & Kişisel)</h4>
              ...
              <div className="p-6 pt-0">
                <a href="#order-form" onClick={() => setFormData({...formData, service: 'web_build', details: 'Hızlı ve modern bir web sitesi açma / yapma hizmeti almak istiyorum.'})} className="text-xs text-blue-600 font-bold uppercase block text-center border border-blue-200 py-2.5 rounded-xl bg-blue-50/50 hover:bg-blue-100 transition-all">Talep Oluştur &rarr;</a>
              </div>
            </div>
            ...
            <div className="bg-white/95 rounded-2xl border border-blue-100 shadow-md overflow-hidden flex flex-col justify-between hover:shadow-lg transition-all">
              <div>
                <div className="h-48 relative overflow-hidden bg-slate-900">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent flex flex-col justify-end p-4">
                    ...
                    <div className="font-bold text-white text-sm">Sıfırdan Mobil Uygulama Geliştirme</div>
                  </div>
                </div>
                <div className="p-6">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-base font-bold text-slate-900">Sıfırdan Mobil Uygulama Yapma</h4>
              ...
              <div className="p-6 pt-0">
                <a href="#order-form" onClick={() => setFormData({...formData, service: 'mobile_app', details: 'Fikrime özel sıfırdan mobil uygulama yapma hizmeti almak istiyorum.'})} className="text-xs text-blue-600 font-bold uppercase block text-center border border-blue-200 py-2.5 rounded-xl bg-blue-50/50 hover:bg-blue-100 transition-all">Talep Oluştur &rarr;</a>
              </div>
            </div>

            {/* 3. Web Tasarımı ve Yenileme */}
            <div className="bg-white/95 rounded-2xl border border-blue-100 shadow-md overflow-hidden flex flex-col justify-between hover:shadow-lg transition-all">
              <div>
                <div className="h-48 relative overflow-hidden bg-slate-900">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent flex flex-col justify-end p-4">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-purple-400 bg-purple-950/80 px-2 py-0.5 rounded border border-purple-500/20 self-start mb-1">Arayüz & Kullanıcı Deneyimi</span>
                    <div className="font-bold text-white text-sm">Özel Şık Web Tasarımı</div>
                  </div>
                </div>
                <div className="p-6">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-base font-bold text-slate-900">Profesyonel Web Tasarımı</h4>
              ...
              <div className="p-6 pt-0">
                <a href="#order-form" onClick={() => setFormData({...formData, service: 'web_design', details: 'Mevcut sitem için modern bir web tasarımı ve revizyon çalışması talep ediyorum.'})} className="text-xs text-blue-600 font-bold uppercase block text-center border border-blue-200 py-2.5 rounded-xl bg-blue-50/50 hover:bg-blue-100 transition-all">Talep Oluştur &rarr;</a>
              </div>
            </div>

            {/* 4. Bot Yazdırma ve Süreç Otomasyonu */}
            <div className="bg-white/95 rounded-2xl border border-blue-100 shadow-md overflow-hidden flex flex-col justify-between hover:shadow-lg transition-all">
              <div>
                <div className="h-48 relative overflow-hidden bg-slate-900">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent flex flex-col justify-end p-4">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-emerald-400 bg-emerald-950/80 px-2 py-0.5 rounded border border-emerald-500/20 self-start mb-1">Node.js Süreç Botları</span>
                    <div className="font-bold text-white text-sm">Akıllı Otomasyon ve Bot Yapımı</div>
                  </div>
                </div>
                <div className="p-6">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-base font-bold text-slate-900">Özel Bot Yazdırma Çözümleri</h4>
                    <span className="text-emerald-600 font-mono font-black text-sm">2.500 TL</span>
                  </div>
                  <p className="text-slate-600 text-xs leading-relaxed">Sürekli tekrarladığınız manuel işleri bota bağlayarak zamandan tasarruf edin. Veri çekme, otomatik paylaşım ve özel süreçler için tam entegre bot yazdırma hizmeti.</p>
                </div>
              </div>
              <div className="p-6 pt-0">
                <a href="#order-form" onClick={() => setFormData({...formData, service: 'bot', details: 'İş süreçlerimi hızlandıracak özel bir bot yazdırma talebim var.'})} className="text-xs text-blue-600 font-bold uppercase block text-center border border-blue-200 py-2.5 rounded-xl bg-blue-50/50 hover:bg-blue-100 transition-all">Talep Oluştur &rarr;</a>
              </div>
            </div>
        ...
        <section id="order-form" className="bg-white border border-blue-200 rounded-3xl p-8 md:p-10 shadow-xl relative z-10">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-2">İhtiyacınız Olan Dijital Çözüm</label>
                <select value={formData.service} onChange={(e) => setFormData({...formData, service: e.target.value})} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:border-blue-500 focus:outline-none transition-all text-slate-900">
                  <option value="web_build">🌐 Profesyonel Web Sitesi Açma ve Yapma (2.000 TL)</option>
                  <option value="mobile_app">📱 Sıfırdan Özel Mobil Uygulama Yapma (5.000 TL)</option>
                  <option value="web_design">🎨 Kullanıcı Dostu Şık Web Tasarımı (1.500 TL)</option>
                  <option value="bot">🤖 Süreç Otomasyonu & Özel Bot Yazdırma (2.500 TL)</option>
              ...
              <div>
                ...
                <textarea required rows={4} value={formData.details} onChange={(e) => setFormData({...formData, details: e.target.value})} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:border-blue-500 focus:bg-white focus:outline-none transition-all text-slate-900 resize-none placeholder-slate-400" placeholder="İstediğiniz projenin (web, mobil, bot) detaylarından kısaca bahsedin..." />
              </div>

              <button type="submit" disabled={isSubmitting} className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 disabled:from-blue-400 disabled:to-indigo-400 text-white font-bold py-4 rounded-xl text-xs uppercase tracking-widest shadow-md shadow-blue-600/10 transition-all cursor-pointer">
