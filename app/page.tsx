...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-slate-800 font-sans selection:bg-blue-600 selection:text-white bg-[#eef5fc] relative" style={{ backgroundImage: 'radial-gradient(#cbd5e1 1px, transparent 1px)', bgSize: '24px 24px', backgroundSize: '24px 24px' }}>
      
      {/* Üst Menü / Navbar */}
      <header className="border-b border-blue-200/80 bg-white/95 backdrop-blur-md sticky top-0 z-50 shadow-md">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <span className="text-xl">✨</span>
            <h1 className="text-base md:text-lg font-black tracking-wider text-slate-950">
              MIRAMI | <span className="text-blue-600">WEB & MOBİL UYGULAMA YAPMA OFİSİ</span>
            </h1>
          </div>
          <a href="#order-form" className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white px-4 py-2 rounded-xl font-bold text-xs uppercase tracking-wider transition-all shadow-md shadow-blue-600/20">
            Hemen Talep Gönder
          </a>
        </div>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12 relative z-10">
        ...
        <section className="text-center mb-16">
          <span className="text-[11px] font-bold uppercase tracking-widest text-blue-700 border border-blue-300 px-4 py-2 rounded-full bg-blue-100/80 shadow-sm inline-block">
          ...
          <p className="text-slate-600 text-sm md:text-base max-w-2xl mx-auto leading-relaxed font-medium">
            İster esnaf dükkanın için hızlı bir web sitesi açma hizmeti, ister profesyonel web tasarımı, yapay zeka entegrasyonları veya süreçleri otomatikleştiren bot yazdırma çözümleri...
          </p>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="text-slate-500 text-xs text-center mb-10 font-medium">İhtiyacın olan profesyonel çözümü seç, Google'da rakiplerinin önüne geç kanka.</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            
            {/* 1. Web Sitesi Açma ve Yapma */}
            <div className="bg-white rounded-2xl border border-blue-100 shadow-xl overflow-hidden flex flex-col justify-between hover:scale-[1.01] transition-all duration-300">
              <div>
            ...
            {/* 3. Yapay Zeka Entegrasyonları (YENİ EKLENDİ) */}
            <div className="bg-white rounded-2xl border border-blue-100 shadow-xl overflow-hidden flex flex-col justify-between hover:scale-[1.01] transition-all duration-300">
              <div>
                <div className="h-48 relative overflow-hidden bg-slate-900">
                ...
                <div className="p-6">
                  ...
                  <p className="text-slate-600 text-xs leading-relaxed">Web sitenize veya mobil uygulamanıza müşterilerle konuşan, destek veren akıllı chatbotlar, GPT modülleri ve otomatik içerik üreten sistemler bağlıyoruz.</p>
                </div>
              </div>
              <div className="p-6 pt-0">
                <a href="#order-form" onClick={() => setFormData({...formData, service: 'ai', details: 'Sistemlerime profesyonel yapay zeka modülleri entegre ettirmek istiyorum.'})} className="text-xs text-blue-600 font-bold uppercase block text-center border border-blue-200 py-2.5 rounded-xl bg-blue-50 hover:bg-blue-100 transition-all">Talep Oluştur &rarr;</a>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-blue-100 shadow-xl overflow-hidden flex flex-col justify-between hover:scale-[1.01] transition-all duration-300">
              ...
              <div className="p-6 pt-0">
                <a href="#order-form" onClick={() => setFormData({...formData, service: 'bot', details: 'İş süreçlerimi hızlandıracak özel bir bot yazdırma talebim var.'})} className="text-xs text-blue-600 font-bold uppercase block text-center border border-blue-200 py-2.5 rounded-xl bg-blue-50 hover:bg-blue-100 transition-all">Talep Oluştur &rarr;</a>
              </div>
            </div>

            {/* 5. Web Tasarımı */}
            <div className="bg-white rounded-2xl border border-blue-100 shadow-xl overflow-hidden flex flex-col justify-between md:col-span-2 max-w-md mx-auto w-full hover:scale-[1.01] transition-all duration-300">
              <div>
                <div className="h-48 relative overflow-hidden bg-slate-900">
        ...
        <section id="order-form" className="bg-white border border-blue-200 rounded-3xl p-8 md:p-10 shadow-2xl relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <select value={formData.service} onChange={(e) => setFormData({...formData, service: e.target.value})} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:border-blue-500 focus:outline-none transition-all text-slate-900">
                  ...
                  <option value="ai">🧠 Yapay Zeka Entegrasyonları ve Chatbot (3.000 TL)</option>
              ...
              <button type="submit" disabled={isSubmitting} className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 disabled:from-blue-400 disabled:to-indigo-400 text-white font-bold py-4 rounded-xl text-xs uppercase tracking-widest shadow-lg shadow-blue-600/20 transition-all cursor-pointer">
      ...
      <footer className="border-t border-blue-200 py-8 text-center text-[10px] font-mono text-slate-400 bg-white relative z-10 shadow-inner">
