...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-slate-800 font-sans selection:bg-blue-600 selection:text-white bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-50 via-indigo-50/40 to-slate-100">
      {/* Üst Menü / Navbar */}
      <header className="border-b border-blue-100/60 bg-white/70 backdrop-blur-md sticky top-0 z-50 shadow-sm">
      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        ...
        <section className="text-center mb-16 relative">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-72 h-72 bg-blue-400/20 blur-3xl rounded-full -z-10"></div>
          <span className="text-[11px] font-bold uppercase tracking-widest text-blue-600 border border-blue-200 px-4 py-1.5 rounded-full bg-blue-100/50 backdrop-blur-sm shadow-sm">
        ...
        <section className="mb-20 bg-white/80 border-2 border-pink-400/60 rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden backdrop-blur-md">
        ...
        <section className="mb-20">
          ...
          <p className="text-slate-500 text-xs text-center mb-10">İhtiyacın olan dijital çözümü seç, bütçeni yormadan işini internete taşı.</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            
            {/* 1. Sıfırdan Mobil Uygulama Yapımı */}
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-100/80 shadow-lg overflow-hidden flex flex-col justify-between hover:shadow-xl transition-all group">
              <div>
                <div className="h-48 relative overflow-hidden bg-slate-900">
                  <img src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=800&q=80" alt="Mobil Uygulama Yapımı" className="w-full h-full object-cover opacity-85 group-hover:scale-102 transition-transform duration-500" />
              ...
              <div className="p-6 pt-0">
                <a href="#order-form" onClick={() => setFormData({...formData, service: 'mobile_app', details: 'Sıfırdan özel mobil uygulama yaptırmak istiyorum.'})} className="text-xs text-blue-600 font-bold uppercase block text-center border border-blue-200 py-2.5 rounded-xl bg-blue-50/50 hover:bg-blue-100 transition-all">Talep Oluştur &rarr;</a>
              </div>
            </div>

            {/* 2. Web Sitesi Yapımı (Esnaf & Kişisel) */}
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-100/80 shadow-lg overflow-hidden flex flex-col justify-between hover:shadow-xl transition-all group">
              <div>
                <div className="h-48 relative overflow-hidden bg-slate-900">
                  <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80" alt="Web Sitesi Yapımı" className="w-full h-full object-cover opacity-85 group-hover:scale-102 transition-transform duration-500" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent flex flex-col justify-end p-4">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-indigo-400 bg-indigo-950/80 px-2 py-0.5 rounded border border-indigo-500/20 self-start mb-1">Next.js & Web Tasarım</span>
              ...
              <div className="p-6 pt-0">
                <a href="#order-form" onClick={() => setFormData({...formData, service: 'web_build', details: 'Kişisel/Esnaf web sitesi yaptırmak istiyorum.'})} className="text-xs text-blue-600 font-bold uppercase block text-center border border-blue-200 py-2.5 rounded-xl bg-blue-50/50 hover:bg-blue-100 transition-all">Talep Oluştur &rarr;</a>
              </div>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-100/80 shadow-lg overflow-hidden flex flex-col justify-between hover:shadow-xl transition-all group">
              <div>
                <div className="h-48 relative overflow-hidden bg-slate-900">
                  <img src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?auto=format&fit=crop&w=800&q=80" alt="Web Tasarım Geliştirme" className="w-full h-full object-cover opacity-85 group-hover:scale-102 transition-transform duration-500" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent flex flex-col justify-end p-4">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-purple-400 bg-purple-950/80 px-2 py-0.5 rounded border border-purple-500/20 self-start mb-1">Modernizasyon & Arayüz</span>
              ...
              <div className="p-6 pt-0">
                <a href="#order-form" onClick={() => setFormData({...formData, service: 'web_design', details: 'Mevcut web sitemin tasarımını yenilemek ve ek özellikler ekletmek istiyorum.'})} className="text-xs text-blue-600 font-bold uppercase block text-center border border-blue-200 py-2.5 rounded-xl bg-blue-50/50 hover:bg-blue-100 transition-all">Talep Oluştur &rarr;</a>
              </div>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-100/80 shadow-lg overflow-hidden flex flex-col justify-between hover:shadow-xl transition-all group">
              <div>
                <div className="h-48 relative overflow-hidden bg-slate-900">
                  <img src="https://images.unsplash.com/photo-1518432031352-d6fc5c10da5a?auto=format&fit=crop&w=800&q=80" alt="Otomasyon ve Bot" className="w-full h-full object-cover opacity-85 group-hover:scale-102 transition-transform duration-500" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent flex flex-col justify-end p-4">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-emerald-400 bg-emerald-950/80 px-2 py-0.5 rounded border border-emerald-500/20 self-start mb-1">Node.js Bot Dünyası</span>
              ...
              <div className="p-6 pt-0">
                <a href="#order-form" onClick={() => setFormData({...formData, service: 'bot', details: 'İşlerimi otomatikleştirecek özel bir bot yazdırmak istiyorum.'})} className="text-xs text-blue-600 font-bold uppercase block text-center border border-blue-200 py-2.5 rounded-xl bg-blue-50/50 hover:bg-blue-100 transition-all">Talep Oluştur &rarr;</a>
              </div>
            </div>

            {/* 5. Yapay Zeka Entegrasyonları */}
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-100/80 shadow-lg overflow-hidden flex flex-col justify-between md:col-span-2 max-w-md mx-auto w-full hover:shadow-xl transition-all group">
              <div>
                <div className="h-48 relative overflow-hidden bg-slate-900">
                  <img src="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=800&q=80" alt="Yapay Zeka" className="w-full h-full object-cover opacity-85 group-hover:scale-102 transition-transform duration-500" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent flex flex-col justify-end p-4">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-amber-400 bg-amber-950/80 px-2 py-0.5 rounded border border-amber-500/20 self-start mb-1">AI Modülleri & Chatbot</span>
              ...
              <div className="p-6 pt-0">
                <a href="#order-form" onClick={() => setFormData({...formData, service: 'ai', details: 'Sistemlerime yapay zeka modülleri entegre ettirmek istiyorum.'})} className="text-xs text-blue-600 font-bold uppercase block text-center border border-blue-200 py-2.5 rounded-xl bg-blue-50/50 hover:bg-blue-100 transition-all">Talep Oluştur &rarr;</a>
              </div>
            </div>
        ...
        <section id="order-form" className="bg-white/90 border border-blue-100/80 rounded-3xl p-8 md:p-10 shadow-xl backdrop-blur-sm">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button type="submit" disabled={isSubmitting} className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 disabled:from-blue-400 disabled:to-indigo-400 text-white font-bold py-4 rounded-xl text-xs uppercase tracking-widest shadow-md shadow-blue-600/10 transition-all cursor-pointer transform hover:-translate-y-0.5">
      ...
      <footer className="border-t border-blue-100/50 py-8 text-center text-[10px] font-mono text-slate-400 bg-white/60 backdrop-blur-sm">
